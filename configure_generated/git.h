...
inline bool IsPopulated() {
  return bmx_git_IsPopulated();
}
inline bool AnyUncommittedChanges() {
  return  bmx_git_AnyUncommittedChanges();
}
inline const StringOrView& AuthorName() {
  static const StringOrView kValue = internal::InitString(bmx_git_AuthorName());
  return kValue;
}
inline const StringOrView AuthorEmail() {
  static const StringOrView kValue = internal::InitString(bmx_git_AuthorEmail());
  return kValue;
}
inline const StringOrView CommitSHA1() {
  static const StringOrView kValue = internal::InitString(bmx_git_CommitSHA1());
  return kValue;
}
inline const StringOrView CommitDate() {
  static const StringOrView kValue = internal::InitString(bmx_git_CommitDate());
  return kValue;
}
inline const StringOrView CommitSubject() {
  static const StringOrView kValue = internal::InitString(bmx_git_CommitSubject());
  return kValue;
}
inline const StringOrView CommitBody() {
  static const StringOrView kValue = internal::InitString(bmx_git_CommitBody());
  return kValue;
}
inline const StringOrView Describe() {
  static const StringOrView kValue = internal::InitString(bmx_git_Describe());
  return kValue;
}
inline const StringOrView Branch() {
  static const StringOrView kValue = internal::InitString(bmx_git_Branch());
  return kValue;
}
inline const StringOrView DescribeTag() {
  static const StringOrView kValue = internal::InitString(bmx_git_DescribeTag());
  return kValue;
}
